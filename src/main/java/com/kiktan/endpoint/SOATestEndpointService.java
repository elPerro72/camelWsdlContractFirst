 ...
 * 2018-10-16T18:39:23.824Z
 * Generated source version: 3.2.6
 *
 */
@WebServiceClient(name = "SOATestEndpointService",
                  wsdlLocation = "file:/C:/git/camelWsdlContractFirst/src/main/resources/wsdl/test.wsdl",
...
public class SOATestEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/git/camelWsdlContractFirst/src/main/resources/wsdl/test.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SOATestEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/git/camelWsdlContractFirst/src/main/resources/wsdl/test.wsdl");
        }
        WSDL_LOCATION = url;
    }
